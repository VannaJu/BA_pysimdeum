...
def chooser(data: Union[pd.Series, pd.DataFrame], myproperty: str='', random_state: int = None):  # Change: Random Seeds 
    ...
    u = np.random.RandomState(seed = random_state).uniform()  # Change: Random Seeds 
